...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel, SocketChannel> {
    ...
    /**
     * 检测 Channel 的 I/O 事件，可读时，创建 {@link SocketProcessor} 任务类，扔给线程池处理
     * The socket poller.
     */
    ...
    /**
     * endPoint 初始化 {@link ServerSocketChannel} 绑定端口
     *
     * @throws Exception
     */
    protected void initServerSocket() throws Exception {
        if (!getUseInheritedChannel()) {
            ...
            // addr 和 等待队列的长度，通过 acceptCount 配置，默认值 100
    ...
    protected boolean setSocketOptions(SocketChannel socket) {
        ...
        try {
            ...
            // 将 Channel 封装为一个 NioSocketWrapper 对象，注册到 Poller 去处理
    ...
    /**
     * 本质是一个 Selector 跑在单独的线程里 内部维护一个 Channel 数组，
     * 死循环里不断检测 Channel 的数据就绪状态， 一旦有 Channel 可读，
     * 就生成一个 SocketProcessor 任务对象给 Excutor 去处理
     * Poller class.
     */
            ...
            while (true) {
                ...
                while (iterator != null && iterator.hasNext()) {
                    ...
                    if (socketWrapper == null) {
                        ...
                        // 处理socket 生成 SocketProcessor 对象给 Excutor 处理
                        processKey(sk, socketWrapper);
                    }
                }

                // Process timeouts 处理超时
